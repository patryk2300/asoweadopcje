(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/material'), require('@angular/forms'), require('@angular/core'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/material', '@angular/forms', '@angular/core', '@angular/animations'], factory) :
    (factory((global.angularMaterialExtensionsPasswordStrength = {}),global.ng.common,global.ng.material,global.ng.forms,global.ng.core,global.ng.animations));
}(this, (function (exports,common,material,forms,core,animations) { 'use strict';
