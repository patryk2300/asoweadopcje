(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@angular/common'), require('firebase/app'), require('firebase/auth'), require('@angular/forms'), require('@angular/platform-browser'), require('@angular/core'), require('@angular/fire'), require('@angular/fire/auth'), require('@angular/flex-layout'), require('@angular/material'), require('@angular/fire/firestore'), require('@angular-material-extensions/password-strength')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common/http', '@angular/common', 'firebase/app', 'firebase/auth', '@angular/forms', '@angular/platform-browser', '@angular/core', '@angular/fire', '@angular/fire/auth', '@angular/flex-layout', '@angular/material', '@angular/fire/firestore', '@angular-material-extensions/password-strength'], factory) :
    (factory((global.ngxAuthFirebaseui = {}),global.ng['common,http'],global.ng.common,global.firebaseApp,null,global.ng.forms,global.ng.platformBrowser,global.ng.core,global.ng.fire,global.ng.fire.auth,global.ng.flexLayout,global.ng.material,global.ng.fire.firestore,global.passwordStrength));
}(this, (function (exports,http,common,firebase,auth,forms,platformBrowser,core,fire,auth$1,flexLayout,material,firestore,passwordStrength) { 'use strict';
    ...
    var AuthProcessService$$1 = /** @class */ (function () {
        ...
        function (email) {
            ...
            return this.afa.auth.sendPasswordResetEmail(email)
                ...
                .catch(function (error) { return _this.onErrorEmitter.next(error); });
        };
        /**
         ...
         * @return {?}
         */
        function (provider, email, password) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 14];
                        case 3: return [4 /*yield*/, this.afa.auth.signInWithEmailAndPassword(email, password)];
                        case 4:
                            signInResult = (/** @type {?} */ (_b.sent()));
                            return [3 /*break*/, 14];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.isLoading = true;
                            return [4 /*yield*/, this.afa.auth.createUserWithEmailAndPassword(email, password)];
                        case 1:
        ...
        function (userCredential) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.config.enableFirestoreSync) return [3 /*break*/, 2];
                        ...
                        case 2:
                            if (this.config.toastMessageOnAuthSuccess) {
                                this._snackBar.open(this.messageOnAuthSuccess ? this.messageOnAuthSuccess :
                                    "Hallo " + (userCredential.user.displayName ? userCredential.user.displayName : '') + "!", 'OK', { duration: 5000 });
                            }
    ...
    var AuthComponent = /** @class */ (function () {
        function AuthComponent(platformId, auth$$1, authProcess, dialog) {
        ...
        function () {
            ...
            setTimeout(function () { return _this.tabIndex = 0; }, 100);
        };
        /**
         * @param {?=} authProvider
         * @return {?}
        ...
        function () {
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator$1(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authProcess.signUp(this.signUpFormGroup.value.name, this.signUpFormGroup.value.email, this.signUpFormGroup.value.password)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        AuthComponent.propDecorators = {
            ...
            guestEnabled: [{ type: core.Input }],
            tosUrl: [{ type: core.Input }],
            privacyPolicyUrl: [{ type: core.Input }],
            goBackURL: [{ type: core.Input }],
            messageOnAuthSuccess: [{ type: core.Input }],
            messageOnAuthError: [{ type: core.Input }],
    ...
    var UserComponent$$1 = /** @class */ (function () {
        function UserComponent$$1(config, auth$$1, authProcess, _fireStoreService, snackBar) {
            this.config = config;
            this.auth = auth$$1;
            this.authProcess = authProcess;
            this._fireStoreService = _fireStoreService;
        ...
        function () {
            ...
            this.updateFormGroup = new forms.FormGroup({
                name: this.updateNameFormControl = new forms.FormControl({ value: currentUser.displayName, disabled: true }, [
                    forms.Validators.required,
                    forms.Validators.minLength(2),
                    forms.Validators.maxLength(25),
                ]),
                email: this.updateEmailFormControl = new forms.FormControl({ value: currentUser.email, disabled: true }, [
                    forms.Validators.required,
                    forms.Validators.pattern(EMAIL_REGEX)
                ]),
                phoneNumber: this.updatePhoneNumberFormControl = new forms.FormControl('', [forms.Validators.pattern(PHONE_NUMBER_REGEX)])
            });
     ...
     */
    /** @type {?} */
    var NgxAuthFirebaseUIConfigToken = new core.InjectionToken('NgxAuthFirebaseUIConfig');
    var NgxAuthFirebaseUIModule = /** @class */ (function () {
        function NgxAuthFirebaseUIModule() {
        }
        /**
         * @param {?} configFactory
        ...
        function (configFactory, appNameFactory, config) {
            if (config === void 0) { config = defaultAuthFirebaseUIConfig; }
            return {
    ...
    exports.UserComponent = UserComponent$$1;
    exports.AuthProvidersComponent = AuthProvidersComponent;
    exports.Theme = Theme;
    exports.Layout = Layout;
    exports.LegalityDialogComponent = LegalityDialogComponent;
    exports.AuthProcessService = AuthProcessService$$1;
    exports.AuthProvider = AuthProvider$$1;
    ...
    exports.ɵb = EmailConfirmationComponent;
