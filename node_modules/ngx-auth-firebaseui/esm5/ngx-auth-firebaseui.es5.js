...
/** @type {?} */
var facebookAuthProvider = new auth.FacebookAuthProvider();
/** @type {?} */
var googleAuthProvider = new auth.GoogleAuthProvider();
/** @type {?} */
var twitterAuthProvider = new auth.TwitterAuthProvider();
/** @type {?} */
var githubAuthProvider = new auth.GithubAuthProvider();
/** @enum {string} */
var AuthProvider$$1 = {
    ALL: 'all',
    ANONYMOUS: 'anonymous',
...
export { AuthComponent, UserComponent$$1 as UserComponent, AuthProvidersComponent, Theme, Layout, LegalityDialogComponent, AuthProcessService$$1 as AuthProcessService, AuthProvider$$1 as AuthProvider, FirestoreSyncService, NgxAuthFirebaseUIConfigToken, NgxAuthFirebaseUIModule, EmailConfirmationComponent as ɵb, defaultAuthFirebaseUIConfig as ɵa };
